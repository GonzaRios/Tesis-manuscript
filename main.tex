...
\fancyfoot[C]{\rule{\textwidth}{0.4pt}\\[0.5ex]%
  \fontsize{11}{13}\selectfont Desarrollo de un sistema de bioacceso mediante voz \\
  para castellano rioplatense en hardware de bajo costo.}
...
\setmainfont{Calibri Regular.ttf}[
    Path = Fonts/,
...
\fbox{\includegraphics[width=13.58cm, height=3.1cm]{Figuras/Formato/Logo Untref.png}}
...
{\bfseries\fontsize{22pt}{24pt} \selectfont Desarrollo de un sistema de bioacceso mediante voz para castellano rioplatense en hardware de bajo costo.\par}

\vspace{22pt}

{\itshape\fontsize{18pt}{24pt}\selectfont \textbf{} \par}
...
{\bfseries\fontsize{14pt}{0pt}\selectfont TESISTA: Gonzalo Rios (40.078.963) \par}
{\bfseries\fontsize{14pt}{0pt}\selectfont TUTOR/A: Ing. Paula Ortega Riera \par}
{\bfseries\fontsize{14pt}{0pt}\selectfont COTUTOR/A: - \par}
...
\hrulefill \\ 
\begin{tabular}{c}
Fecha de defensa: Mayo 2026 $\lvert$ Locación: Caseros, Argentina \\
\end{tabular}
\end{table}
\hrule
\end{titlepage}
