...
\fancyfoot[C]{\rule{\textwidth}{0.4pt}\\[0.5ex]%
  \fontsize{11}{13}\selectfont Título de la tesis.}
...
{\bfseries\fontsize{22pt}{24pt} \selectfont Título de la Tesis \par}
...
{\bfseries\fontsize{14pt}{0pt}\selectfont TESISTA: Nombre Apellido (DNI) \par}
{\bfseries\fontsize{14pt}{0pt}\selectfont TUTOR/A: Nombre y Apellido del Tutor \par}
{\bfseries\fontsize{14pt}{0pt}\selectfont COTUTOR/A: Nombre y Apellido del Cotutor (si hubiera) \par}
